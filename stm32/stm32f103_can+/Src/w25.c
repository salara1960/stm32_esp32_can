...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "%s done after %u ms!\r\n", __func__, HAL_GetTick() - StartTime);
#endif
    W25qxx_Delay(10);
...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "w25qxx CheckPage:0x%X(%u), Offset:%u, Bytes:%u begin...\r\n",
...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "w25qxx CheckPage is Empty in %u ms\r\n", HAL_GetTick() - StartTime);
    W25qxx_Delay(100);
#endif
...
#ifdef W25QXX_DEBUG
	Report(TAGW25, true, "w25qxx CheckPage is Not Empty in %u ms\r\n", HAL_GetTick() - StartTime);
	W25qxx_Delay(100);
#endif
...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "w25qxx CheckSector:0x%X(%u), Offset:%u, Bytes:%u begin...\r\n",
...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "w25qxx CheckSector is Empty in %u ms\r\n", HAL_GetTick() - StartTime);
    W25qxx_Delay(100);
#endif
...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "w25qxx CheckSector is Not Empty in %u ms\r\n", HAL_GetTick() - StartTime);
    W25qxx_Delay(100);
#endif
...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "w25qxx CheckBlock:0x%X(%u), Offset:%u, Bytes:%u begin...\r\n",
...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "w25qxx CheckBlock is Empty in %u ms\r\n", HAL_GetTick() - StartTime);
    W25qxx_Delay(100);
#endif
...
#ifdef W25QXX_DEBUG
	Report(TAGW25, true, "w25qxx CheckBlock is Not Empty in %u ms\r\n", HAL_GetTick() - StartTime);
	W25qxx_Delay(100);
#endif
...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "%s done after %d ms\r\n", __func__, HAL_GetTick() - StartTime);
#endif
...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "%s WritePage:0x%X(%u), Offset:%u ,Writes %u Bytes, begin...\r\n",
...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "%s WriteSector:0x%X(%u), Offset:%u ,Write %u Bytes, begin...\r\n",
...
#ifdef W25QXX_DEBUG
    	Report(TAGW25, true, "---w25qxx WriteSector Faild!\r\n");
    	W25qxx_Delay(100);
#endif
        return;
    }
...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "%s WriteBlock:0x%X(%u), Offset:%u ,Write %u Bytes, begin...\r\n",
...
#ifdef W25QXX_DEBUG
    uint32_t StartTime = HAL_GetTick();
    Report(TAGW25, true, "%s at address %u begin...\r\n", __func__, Bytes_Address);
#endif
...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "%s 0x%02X done after %u ms\r\n", __func__, *pBuffer, HAL_GetTick() - StartTime);
#endif
...
#ifdef W25QXX_DEBUG
    uint32_t StartTime = HAL_GetTick();
    Report(TAGW25, true, "%s at Address:0x%X(%u), %u Bytes  begin...\r\n",
...
#ifdef W25QXX_DEBUG
    Report(TAGW25, true, "%s:0x%X(%u), Offset:%u ,Read %u Bytes, begin...\r\n",
...
void W25qxx_ReadSector(uint8_t *pBuffer, uint32_t Sector_Address, uint32_t OffsetInByte, uint32_t NumByteToRead_up_to_SectorSize)
{
    ...
    if (OffsetInByte >= w25qxx.SectorSize) {
#ifdef W25QXX_DEBUG
    	Report(TAGW25, true, "---w25qxx ReadSector Faild!\r\n");
    	W25qxx_Delay(100);
#endif
        return;
    }
