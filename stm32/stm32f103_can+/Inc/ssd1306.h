...
//------------------------------------------------------------------------
	...
	extern HAL_StatusTypeDef spi_ssd1306_WriteCmds(uint8_t *cmds, uint16_t sz);
	extern HAL_StatusTypeDef spi_ssd1306_WriteData(const char *buf, uint16_t sz, bool with);
#endif
	...
	extern void ssd1306_clear_line(uint8_t cy);
	extern void ssd1306_text_xy(const char *stroka, uint8_t cx, uint8_t cy);
